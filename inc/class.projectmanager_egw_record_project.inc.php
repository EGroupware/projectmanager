...
/**
 * class projectmanager_egw_record_project
 *
 * compability layer for iface_egw_record needet for importexport
 * This class is just for a project, not its elements
 */
class projectmanager_egw_record_project implements importexport_iface_egw_record
{
	private $identifier = '';
