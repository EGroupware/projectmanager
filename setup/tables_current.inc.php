...
$phpgw_baseline = array(
	'egw_pm_projects' => array(
		'fd' => array(
			'pm_id' => array('type' => 'auto','nullable' => False,'comment' => 'unique id of the project'),
			...
			'pm_used_budget' => array('type' => 'decimal','precision' => '20','scale' => '2','comment' => 'used budget'),
			'pm_planned_budget' => array('type' => 'decimal','precision' => '20','scale' => '2','comment' => 'planned budget'),
			'pm_overwrite' => array('type' => 'int','precision' => '4','default' => '0','comment' => 'bit-field, if set datasource-values is overwritten by stored value'),
			'pm_accounting_type' => array('type' => 'varchar','precision' => '10','default' => 'times','comment' => 'accounting type: times, status, budget, pricelist')
		),
		'pk' => array('pm_id'),
		'fk' => array(),
		'ix' => array('pm_title'),
